...
export const CADASTRO_USUARIO_SUCESSO = 'cadastra_usuario_erro';
export const CADASTRO_USUARIO_ERRO = 'cadastra_usuario_sucesso';
...
export const ADICIONA_CONTATO_EMAIL = 'adiciona_contato_email';
